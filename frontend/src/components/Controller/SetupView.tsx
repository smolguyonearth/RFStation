    ...
    <div className="flex-1 p-6 md:p-12 flex flex-col items-center justify-center animate-fade-in min-h-screen bg-[#FAF9F6] text-[#333C4E] font-sans relative overflow-hidden">
      ...
      <div className="w-full max-w-3xl bg-white rounded-[2.5rem] shadow-cute p-10 md:p-14 flex flex-col items-center border border-[#FFF0F3] z-10">
        ...
        <div className="text-center mb-12 max-w-md w-full">
          <span className="text-[10px] font-bold tracking-[0.3em] text-[#3F72AF] bg-[#3F72AF]/10 border border-[#3F72AF]/20 px-4 py-1.5 rounded-full uppercase">
            {t("setup.system")}
          </span>
        ...
        <div className="mb-12 flex space-x-1 bg-stone-100 p-1 rounded-2xl border border-stone-200 shadow-inner">
          {(["EN", "TH", "DE"] as Language[]).map((lang) => (
            <button
              ...
              className={`w-14 h-9 text-[10px] font-bold uppercase tracking-widest rounded-xl transition-all duration-300 ${selectedLang === lang
                ? "bg-[#364F6B] text-white shadow-md" // สี Navy เมื่อถูกเลือก
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full">
          ...
          >
            <div className="flex justify-between items-start w-full">
              ...
              <div className="p-3.5 bg-[#3FC1C9]/10 text-[#3FC1C9] border border-[#3FC1C9]/20 rounded-2xl transition-transform duration-300 group-hover:scale-105">
              ...
              <div className="text-stone-300 group-hover:text-[#3FC1C9] group-hover:translate-x-0.5 transition-all duration-300">
            ...
            <div>
              <h2 className="text-lg font-extrabold text-[#333C4E] tracking-wide transition-colors duration-300 group-hover:text-[#3FC1C9]">
          ...
          >
            <div className="flex justify-between items-start w-full">
              ...
              {/* Icon Container: ใช้พื้นหลังจางๆ ของ FC5185 */}
              <div className="p-3.5 bg-[#FC5185]/10 text-[#FC5185] border border-[#FC5185]/20 rounded-2xl transition-transform duration-300 group-hover:scale-105">
                <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              ...
              {/* Arrow Icon: ใช้สี stone-300 และเปลี่ยนเป็น FC5185 เมื่อ Hover */}
              <div className="text-stone-300 group-hover:text-[#FC5185] group-hover:translate-x-0.5 transition-all duration-300">
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" />
                </svg>
              </div>
            ...
            <div>
              <h2 className="text-lg font-extrabold text-[#333C4E] tracking-wide transition-colors duration-300 group-hover:text-[#FC5185]">
                {t("setup.game_title")}
              </h2>
              <p className="text-zinc-400 text-xs font-bold tracking-wide mt-2">
